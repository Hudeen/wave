...
import agma from '../../assets/images/agma.jpg'
import shutta from '../../assets/images/shutta.jpg'
...
import buttonBack from '../../assets/images/buttons-back.jpg'

import float1 from '../../assets/images/float1.jpg'
import float2 from '../../assets/images/float2.jpg'
import float3 from '../../assets/images/float3.jpg'
import float4 from '../../assets/images/float4.jpg'

import kontakt1 from '../../assets/images/kontakt1.jpg'
import kontakt2 from '../../assets/images/kontakt2.jpg'
import kontakt3 from '../../assets/images/kontakt3.jpg'
import kontakt4 from '../../assets/images/kontakt4.jpg'

import pirs1 from '../../assets/images/pirs1.jpg'
import pirs2 from '../../assets/images/pirs2.jpg'
import pirs3 from '../../assets/images/pirs3.jpg'
import pirs4 from '../../assets/images/pirs4.jpg'
            ...
            <div className='home'>
                ...
                <div className='main'>
                    <div className='info'>
                        ...
                        <h3>19-21 Июля</h3>
                        <button className='desktop'>Купить билет</button>
                    </div>
                    <div className='artists'>
                        <p>
                            SecretGuest Pola Agmalive Shutta Rinat Gabba NAASA Seething Flow Tsarapkin TAYU live Beloklokov
                    ...
                    <button className='mobile'>Купить билет</button>
                </div>
                ...
                <div className='title-headliners'>
                    <h1>ХЕДЛАЙНЕРЫ</h1>
                </div>
                ...
                <div className='position'>
                    ...
                    <div className='map'><iframe src="https://yandex.ru/map-widget/v1/?ll=60.111922%2C55.162625&mode=search&oid=173171544736&ol=biz&sctx=ZAAAAAgBEAAaKAoSCfiNrz2zzENAEUuTUtDtTUpAEhIJRG0bRkHwyj8R5A8GnnsPtz8iBgABAgMEBSgKOABAzFdIAWoCcnWdAc3MTD2gAQCoAQC9ARfRy3vCAQagpdCOhQWCAhfQotGD0YDQs9C%2B0Y%2FQuiDRgdC40YLQuIoCAJICBjEyMTgyOZoCDGRlc2t0b3AtbWFwcw%3D%3D&sll=60.111922%2C55.162625&sspn=0.139816%2C0.056280&text=%D0%A2%D1%83%D1%80%D0%B3%D0%BE%D1%8F%D0%BA%20%D1%81%D0%B8%D1%82%D0%B8&z=13.59"></iframe></div>
                </div>
                <Footer />
            </div>
        </>
